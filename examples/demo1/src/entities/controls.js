...
class VirtualJoypad extends me.Container {
  constructor() {
    ...
    this.joypad = new Joypad(50, me.game.viewport.height - 200)

    // instance of the button
    this.button = new Button(me.game.viewport.width - 150, me.game.viewport.height - 150)
    ...
    var self = this
    me.event.on(me.event.VIEWPORT_ONRESIZE, function (width, height) {
